...
const revFgt = [0, 0, 0, 3, 3]; //Rev F Firmware
const revG = [0, 0, 0, 4, 0]; //Rev F Firmware
const revGgt = [0, 0, 0, 4, 3]; //Rev F Firmware
...
function matchConfig() {
    ...
    if (match == 0) {
        ...
        if (answer) {
            window.location =
                "https://github.com/MakerGear/m2firmware/archive/IZIYq.zip";
        } else answer = false;
    }
